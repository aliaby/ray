...
#include "ray/core_worker/core_worker_profiler.h"
...
class CoreWorker : public rpc::CoreWorkerServiceHandler {
 ...
 private:
  ...
  std::map<size_t, std::vector<double>> tasks_run_time;

  std::map<size_t, CoreWorkerProfiler*> task_profilers;
